    ...
    Array.from(codeBlocks).forEach((pre) => {
        ...
        header.innerHTML = `
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <button class="copy-btn opacity-0 group-hover:opacity-100 transition-opacity focus:opacity-100 flex items-center gap-1.5 text-xs font-mono text-slate-400 hover:text-(--accent) cursor-pointer focus-visible:ring-2 focus-visible:ring-(--accent) focus-visible:ring-offset-2 focus-visible:outline-none dark:focus-visible:ring-offset-(--bg-main) rounded-sm" aria-label="Copy code" aria-live="polite">
