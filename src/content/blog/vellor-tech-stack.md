...
| **Vitest 4 + RTL**          | Tests      | 64 test files at v4.2.0 (`vitest run`; 63 passed, 1 pre-existing fail in `DashboardCharts.test.tsx` when I ran it) — store slices, crypto, PDF, pages, hooks, UI — CI runs lint → test → build |
