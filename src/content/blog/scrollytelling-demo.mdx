...
For the full DeltaV Lab story, read the dedicated transmissions: [why it exists](/transmissions/deltav-lab-why-and-what/), [the physics inside](/transmissions/deltav-lab-science/), and [why it is not professional-grade](/transmissions/deltav-lab-not-professional-grade/) — I would rather you see the caveats upfront than discover them from README hype.
