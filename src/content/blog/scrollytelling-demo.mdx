...
description: 'A study on launch trajectories, staging calculations, and circularization burns using native scroll-driven animations.'
pubDate: 'May 29 2026'
...
In orbital mechanics, delivering a payload into low Earth orbit (LEO) is a sequential game of momentum, gravity, and precise staging. Instead of displaying this as a static list of equations, we use scroll-driven telemetry graphics to visualize each phase of flight in real-time.

Below is an interactive breakdown of a standard launch profile, demonstrating the flight telemetry, staging, and orbital circularization of the Delta-V test vehicle.
...
<Scrollytell stepCount={3}>
  ...
  {/* --- Visual Slide 2 --- */}
  <div slot="visual-2" class="w-full h-full flex flex-col justify-between p-4 font-mono text-[10px] text-slate-400">
    <div class="flex justify-between border-b border-white/10 pb-1.5">
    ...
    <div class="relative grow flex items-center justify-center">
      <svg viewBox="0 0 400 400" class="w-72 h-72 text-slate-500">
        ...
        <path d="M 100,300 Q 200,150 300,120" fill="none" stroke="currentColor" stroke-opacity="0.3" stroke-width="1.5" />
        
        <g transform="translate(210, 160) rotate(35)">
          <g transform="translate(-25, 10) rotate(-15)">
            <rect x="0" y="0" width="8" height="24" fill="currentColor" fill-opacity="0.1" stroke="currentColor" stroke-width="1" />
            <line x1="4" y1="24" x2="4" y2="30" stroke="currentColor" stroke-dasharray="2" />
          </g>
          <g transform="translate(10, -10)">
            <path d="M 4,0 L 8,6 L 8,20 L 0,20 L 0,6 Z" fill="currentColor" fill-opacity="0.2" stroke="var(--accent)" stroke-width="1.5" />
            <path d="M 2,20 L 4,28 L 6,20 Z" fill="#3b82f6" opacity="0.9" />
          </g>
          <circle cx="0" cy="10" r="15" stroke="#eab308" stroke-dasharray="3" stroke-width="1" fill="none" opacity="0.6" />
        </g>
      </svg>
    </div>
    <div class="grid grid-cols-2 gap-2 border-t border-white/10 pt-1.5 text-[9px]">
  ...
  {/* --- Visual Slide 3 --- */}
  <div slot="visual-3" class="w-full h-full flex flex-col justify-between p-4 font-mono text-[10px] text-slate-400">
    <div class="flex justify-between border-b border-white/10 pb-1.5">
    ...
    <div class="relative grow flex items-center justify-center">
      <svg viewBox="0 0 400 400" class="w-72 h-72 text-slate-500">
        <circle cx="100" cy="300" r="80" fill="none" stroke="currentColor" stroke-opacity="0.15" stroke-width="1" />
        <circle cx="100" cy="300" r="85" fill="none" stroke="currentColor" stroke-opacity="0.08" stroke-dasharray="2" />
        
        <ellipse cx="160" cy="240" rx="140" ry="110" fill="none" stroke="currentColor" stroke-dasharray="3" stroke-opacity="0.3" transform="rotate(-15, 160, 240)" />
        
        <circle cx="100" cy="300" r="190" fill="none" stroke="var(--accent)" stroke-width="1.5" stroke-opacity="0.6" />
        ...
        <g transform="translate(234, 165) rotate(45)">
          ...
          <rect x="-26" y="-3" width="16" height="6" fill="none" stroke="var(--accent)" stroke-width="1" />
          <rect x="10" y="-3" width="16" height="6" fill="none" stroke="var(--accent)" stroke-width="1" />
          <path d="M -10,0 L -22,0 M -18,-4 L -25,-4 M -18,4 L -25,4" stroke="#a855f7" stroke-width="1.5" />
        </g>
      </svg>
    </div>
    <div class="grid grid-cols-2 gap-2 border-t border-white/10 pt-1.5 text-[9px]">
  ...
  {/* --- Step 1 Text Card --- */}
  <div slot="step-1">
    <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-2">Phase 1: Vertical Ascent & Max Q</h3>
  ...
  {/* --- Step 2 Text Card --- */}
  <div slot="step-2">
    <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-2">Phase 2: Main Engine Cut-Off & Staging</h3>
    <p class="text-sm text-slate-600 dark:text-slate-400">
...
### The Mathematical Principles Behind Staging
...
By matching the scrolling velocity of the reader directly to the visualization, we allow complex telemetry profiles to be digested at an individual reader's natural pace.
