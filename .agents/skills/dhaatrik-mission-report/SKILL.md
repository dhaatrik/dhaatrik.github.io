...
- **No boilerplate "Challenges & Outlook" summaries:** Never close a report with synthetic corporate cheerleading (e.g. _"Despite these hurdles, the future remains bright..."_). State real unresolved questions or the immediate next commit.
...
- **Concrete Root Cause over Vague Handwaving:** In the _Fuckups & Learnings_ section, state the exact failure mechanism (e.g. memory leak, race condition, bad schema) rather than abstract phrases like _"we faced architectural challenges"_.
